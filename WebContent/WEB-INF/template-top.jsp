		...
		<nav class="navbar navbar-inverse" role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="#">Extreme Sports</a>
				</div>
				...
				<div class="collapse navbar-collapse"
					...
					<ul id="group-function" class="nav navbar-nav">
						<li class="active" id="twitter" name="twitterInfo"><a href="twitterInfo.do">
								Twitter</a></li>
						<li id="flicker" name="searchFlickr"><a href="searchFlickr.do">Flicker
								</a></li>
						<li id="people-nearby" name="searchNearby"><a href="searchNearby.do">Explore the World
								</a></li>
